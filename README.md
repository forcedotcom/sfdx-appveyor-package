...
This repository shows one way you can successfully use scratch orgs to create new package versions with AppVeyor. We make a few assumptions in this README. Continue only if you have completed these critical configuration prerequisites.

- You know how to get your repository set up with Appveyor Pipelines. (Need help? See the AppVeyor [Getting Started guide](https://www.appveyor.com/docs/enterprise/).)
...
- Store the `key`, and `iv` values somewhere safe. You'll use these values in a subsequent step in the AppVeyor UI. These values are considered *secret* so treat them as such.
...
11) Create the sample package: `sfdx force:package:create -r force-app/main/default/ -n "Appveyor" -d "Appveyor Package Example" -t Unlocked`
...
Now you're ready to go! When you commit and push a change, your change kicks off an AppVeyor build.

Enjoy!

## Contributing to the Repository ###

If you find any issues or opportunities for improving this repository, fix them! Feel free to contribute to this project by [forking](http://help.github.com/fork-a-repo/) this repository and makinge changes to the content. Once you've made your changes, share them back with the community by sending a pull request. Ssee [How to send pull requests](http://help.github.com/send-pull-requests/) for more information about contributing to GitHub projects.
